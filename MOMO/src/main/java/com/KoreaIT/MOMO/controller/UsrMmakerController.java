...
public class UsrMmakerController {
	...
	public String doWrite(String moimMain, String moimBody, String moimImg, String moimDatetime, String moimPlace,
		...
		return Util.jsReplace(Util.f("%d번 모임이 생성되었습니다", id), Util.f("../home"));
	}
	...
	public String showMoimL(Model model, @RequestParam(defaultValue = "title") String searchKeywordType, @RequestParam(defaultValue = " ") String searchKeyword ) {
		...
		return "usr/mmaker/moimL";
	}
	
	@RequestMapping("/usr/Mmaker/moimP")
	public String showMoimP(Model model) {

		List<Mmaker> mmakers = mmakerService.getMmakersP();

		model.addAttribute("mmakers", mmakers);

		return "usr/mmaker/moimP";
	}
