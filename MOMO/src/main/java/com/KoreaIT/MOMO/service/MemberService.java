...
public class MemberService {
	...
	public ResultData<Integer> doJoin(String loginId, String loginPw, String name, String nickname, String gender, String birthday, String cellphoneNum, String email) {
		...
		memberRepository.doJoin(loginId, loginPw, name, nickname, gender, birthday, cellphoneNum, email);
