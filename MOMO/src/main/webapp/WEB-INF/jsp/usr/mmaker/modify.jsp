				...
				<div class="table-box-type-1">
					<table  class="table table-zebra w-full">
						...
						<tbody>
							...
							<tr>
								<th>제목</th>
								<td><input class="input input-bordered w-full" type="text" name="title" value="${mmaker.title }" placeholder="제목을 입력해주세요"/></td>
							</tr>
							<tr>
								<th>내용</th>
								<td><textarea class="textarea textarea-bordered w-full" name="body" placeholder="내용을 입력해주세요">${mmaker.body }</textarea></td>
							</tr>
